...
<body>
    ...
    <div class="container-fluid">
       <div class="row justify-content-center">
         <div class="col-md-10">
           <h3 class="text-center text-dark mt-2 display-4">LOGIN</h3>
         </div>
       </div>
<hr><br>
         ...
         <div class="col-md-4">
           ...
           <form action="action.php" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                 ...
                 <input type="submit" name="log" class="btn btn-primary btn-block"
                 value="Connect" >
             ...
             <form action="action.php" method="post" enctype="multipart/form-data">
             <input type="submit" name="reg" class="btn btn-success btn-block mt-2"
                 value="Register" ></div>
                 </form>
         </div>
       </div>
