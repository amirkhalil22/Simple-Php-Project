<?php 
session_start();
$connect = mysqli_connect("localhost", "root", "", "commandepc");
...
<a class="navbar-brand" href="http://localhost/phpproject/welcome.php">
    <img src="deconnect.jpg" alt="Logo" style="width:40px;">
		...
		<div class="container">
			...
			<br />
			<br />
			<h2 align="center" style="color:blue;">Mon Panier </h2><br />
			<br /><br />
			<?php
				$query = "SELECT * FROM ordinateur ORDER BY id ASC";
			...
			<div class="table-responsive">
				...
				<form >
				<a href="http://localhost/phpproject/payment.php"><input type="button" name="conn" style=margin-left:85% class="btn btn-success "
				
                 value="Passer La Commande" ></a>
					</form>
			</div>
		</div>
	</div>
